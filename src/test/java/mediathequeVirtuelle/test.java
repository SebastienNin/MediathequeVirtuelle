...
public class test {
	...
	public static void main(String[] args) {
		...
		VideoGame vg1 = new VideoGame("Zelda : Tears of the Kingdom", "Nintendo", "Français", "Jaquette_totk",
				...
				LocalDate.now(), 12, false, new GameTheme("Action, Aventure, RPG", entryID++));
		...
		Magazine magazine1 = new Magazine("Elle", "Défense de la France", "français", "Image Elle", "Magazine féminin",
				...
				MagazinePeriodicity.Hebdomadaire, new MagazineTheme("Presse féminine", entryID++));
		...
		Music music1 = new Music("Truth is a beautiful thing", "Ministry of Sound Recordings", "français",
				...
				"London Grammar", 79, 18, MusicSupport.NoSupport, new MusicTheme("Indie, trip hop", entryID++));
		...
		Movie movie1 = new Movie("Barbie", "Warner Bros. Pictures", "Français", "logo_film_barbie",
				...
				false, LocalDate.parse("2023-07-19"), LocalDate.now(), movieDirectors, movieActors, 115,
				MovieSupport.NoSupport, new MovieTheme("Aventure, Comédie, Famille", entryID++));
